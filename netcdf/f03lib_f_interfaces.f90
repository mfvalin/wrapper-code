...
!-------------------------------  udrand -------------------------------------
 ...
 Interface
  Function myrand(iflag) BIND(C,name='myrand')
...
!-------------------------------  udshift -------------------------------------
 ...
 Interface
  Function myshift(cvalue, camount) BIND(C,name='myshift')
   USE ISO_C_BINDING, ONLY: C_INT
...
!-------------------------------  ignorefpe  ----------------------------------
 ...
 Interface
  Subroutine nc_ignorefpe(cdoit) BIND(C,name='nc_ignorefpe')
   USE ISO_C_BINDING, ONLY: C_INT
...
!-------------------------------  max_uchar  ----------------------------------
 ...
 Interface
  Function cmax_uchar() BIND(C,name='cmax_uchar')
...
!-------------------------------  min_schar  ----------------------------------
 ...
 Interface
  Function cmin_schar() BIND(C,name='cmin_schar')
   USE ISO_C_BINDING, ONLY: C_DOUBLE
...
!-------------------------------  max_schar  ----------------------------------
 ...
 Real(KIND=C_DOUBLE) :: ccmax
 Interface
  Function cmax_schar() BIND(C,name='cmax_schar')
   USE ISO_C_BINDING, ONLY: C_DOUBLE
...
!-------------------------------  min_short  ----------------------------------
 ...
 Real(KIND=C_DOUBLE) :: ccmin
 Interface
  Function cmin_short() BIND(C,name='cmin_short')
   USE ISO_C_BINDING, ONLY: C_DOUBLE
...
!-------------------------------  max_short  ----------------------------------
 ...
 Real(KIND=C_DOUBLE) :: ccmax
 Interface
  Function cmax_short() BIND(C,name='cmax_short')
   USE ISO_C_BINDING, ONLY: C_DOUBLE
...
!-------------------------------  min_int  ----------------------------------
 ...
 Real(KIND=C_DOUBLE) :: ccmin
 Interface
  Function cmin_int() BIND(C,name='cmin_int')
   USE ISO_C_BINDING, ONLY: C_DOUBLE
...
!-------------------------------  max_int  ----------------------------------
 ...
 Real(KIND=C_DOUBLE) :: ccmax
 Interface
  Function cmax_int() BIND(C,name='cmax_int')
   USE ISO_C_BINDING, ONLY: C_DOUBLE
...
!-------------------------------  min_long  ----------------------------------
 ...
 Real(KIND=C_DOUBLE) :: ccmin
 Interface
  Function cmin_long() BIND(C,name='cmin_long')
   USE ISO_C_BINDING, ONLY: C_DOUBLE
...
!-------------------------------  max_long  ----------------------------------
 ...
 Real(KIND=C_DOUBLE) :: ccmax
 Interface
  Function cmax_long() BIND(C,name='cmax_long')
   USE ISO_C_BINDING, ONLY: C_DOUBLE
...
!-------------------------------  max_float  ----------------------------------
 ...
 Real(KIND=C_DOUBLE) :: ccmax
 Interface
  Function cmax_float() BIND(C,name='cmax_float')
   USE ISO_C_BINDING, ONLY: C_DOUBLE
...
!-------------------------------  max_double  ----------------------------------
 ...
 Real(KIND=C_DOUBLE) :: ccmax
 Interface
  Function cmax_double() BIND(C,name='cmax_double')
   USE ISO_C_BINDING, ONLY: C_DOUBLE
