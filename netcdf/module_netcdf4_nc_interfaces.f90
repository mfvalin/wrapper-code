...
Interface
 Function nc_create_par_fortran(path, cmode, comm, info, ncidp) BIND(C,name='nc_create_par_fortran')
...
!----------------------------- nc_open_par_fortran ---------------------------
Interface
 Function nc_open_par_fortran(path, mode, comm, info, ncidp) BIND(C,name='nc_open_par_fortran')
...
!------------------------------- nc_var_par_access ----------------------------
Interface
 Function nc_var_par_access(ncid, varid, par_access) BIND(C,name='nc_var_par_access')
...
!------------------------------- nc_inq_grpname_full --------------------------
Interface
 Function nc_inq_grpname_full(ncid, nlen, name) BIND(C,name='nc_inq_grpname_full')
...
!------------------------------- nc_inq_grpname_len ---------------------------
Interface
 Function nc_inq_grpname_len(ncid, nlen) BIND(C,name='nc_inq_grpname_len')
...
Interface
 Function nc_inq_grp_full_ncid(ncid, full_name, grp_ncid) BIND(C,name='nc_inq_grp_full_ncid')
...
!------------------------------- nc_inq_grp_ncid ------------------------------
Interface
 Function nc_inq_grp_ncid(ncid, grp_name, grp_ncid) BIND(C,name='nc_inq_grp_ncid')
...
!------------------------------- nc_inq_varids_f ------------------------------
Interface
 Function nc_inq_varids_f(ncid, nvars, varids) BIND(C,name='nc_inq_varids_f')
...
!------------------------------- nc_inq_dimids_f ------------------------------
Interface
 Function nc_inq_dimids_f(ncid, ndims, dimids, parent) BIND(C,name='nc_inq_dimids_f')
...
!------------------------------- nc_inq_typeids -------------------------------
Interface
 Function nc_inq_typeids(ncid, ntypes, typeids) BIND(C,name='nc_inq_typeids')
...
!------------------------------- nc_inq_typeid --------------------------------
Interface
 Function nc_inq_typeid(ncid, name, typeid) BIND(C,name='nc_inq_typeid')
...
!------------------------------- nc_rename_grp --------------------------------
Interface
 Function nc_rename_grp(grpid, name) BIND(C,name='nc_rename_grp')
...
!------------------------------- nc_def_compound ------------------------------
Interface
 Function nc_def_compound(ncid, isize, name, typeidp) BIND(C,name='nc_def_compound')
...
!------------------------------- nc_insert_compound ---------------------------
Interface
 Function nc_insert_compound(ncid, xtype, name, offset, field_typeid) BIND(C,name='nc_insert_compound')
...
Interface
 Function nc_insert_array_compound_f(ncid, xtype, name, offset, field_typeid, &
                                     ndims, dim_sizes) BIND(C,name='nc_insert_array_compound_f')
...
!------------------------------- nc_inq_type ----------------------------------
Interface
 Function nc_inq_type(ncid, xtype, name, isize) BIND(C,name='nc_inq_type')
...
!------------------------------- nc_inq_compound -----------------------------
Interface
 Function nc_inq_compound(ncid, xtype, name, isize, nfieldsp) BIND(C,name='nc_inq_compound')
...
Interface
 Function nc_inq_compound_name(ncid, xtype, name) BIND(C,name='nc_inq_compound_name')
...
Interface
 Function nc_inq_compound_size(ncid, xtype, isize) BIND(C,name='nc_inq_compound_size')
...
Interface
 Function nc_inq_compound_nfields(ncid, xtype, nfieldsp) BIND(C,name='nc_inq_compound_nfields')
...
Interface
 Function nc_inq_compound_field_f(ncid, xtype, fieldid, name, offsetp, &
                                  field_typeidp, ndimsp, dim_sizesp) BIND(C,name='nc_inq_compound_field_f')
...
Interface
 Function nc_inq_compound_fieldoffset(ncid, xtype, fieldid, offsetp) BIND(C,name='nc_inq_compound_fieldoffset')
...
Interface
 Function nc_inq_compound_fieldname(ncid, xtype, fieldid, name) BIND(C,name='nc_inq_compound_fieldname')
...
Interface
 Function nc_inq_compound_fieldindex(ncid, xtype, name, fieldidp) BIND(C,name='nc_inq_compound_fieldindex')
...
Interface
 Function nc_inq_compound_fieldtype(ncid, xtype, fieldid, field_typeidp) BIND(C,name='nc_inq_compound_fieldtype')
...
Interface
 Function nc_inq_compound_fieldndims(ncid, xtype, fieldid, ndimsp) BIND(C,name='nc_inq_compound_fieldndims')
...
Interface
 Function nc_inq_compound_fielddim_sizes(ncid, xtype, fieldid, dim_sizes) BIND(C,name='nc_inq_compound_fielddim_sizes')
...
!------------------------------- nc_def_vlen ----------------------------------
Interface
 Function nc_def_vlen(ncid, name, base_typeid, xtypep) BIND(C,name='nc_def_vlen')
...
!------------------------------- nc_inq_vlen ----------------------------------
Interface
 Function nc_inq_vlen(ncid, xtype, name, datum_sizep, base_nc_typep) BIND(C,name='nc_inq_vlen')
...
Interface
 Function nc_inq_user_type(ncid, xtype, name, isize, base_nc_typep, &
                           nfieldsp, classp) BIND(C,name='nc_inq_user_type')
...
!------------------------------- nc_def_enum ----------------------------------
Interface
 Function nc_def_enum(ncid, base_typeid, name, typeidp) BIND(C,name='nc_def_enum')
...
!------------------------------- nc_insert_enum -------------------------------
Interface
 Function nc_insert_enum(ncid, xtype, name, values) BIND(C,name='nc_insert_enum')
...
Interface
 Function nc_inq_enum(ncid, xtype, name, base_nc_typep, base_sizep, &
                      num_membersp) BIND(C,name='nc_inq_enum')
...
!------------------------------- nc_inq_enum_member ---------------------------
Interface
 Function nc_inq_enum_member(ncid, xtype, idx, name, value) BIND(C,name='nc_inq_enum_member')
...
!------------------------------- nc_inq_enum_ident ----------------------------
Interface
 Function nc_inq_enum_ident(ncid, xtype, val, name) BIND(C,name='nc_inq_enum_ident')
...
!------------------------------- nc_def_opaque --------------------------------
Interface
 Function nc_def_opaque(ncid, isize, name, xtypep) BIND(C,name='nc_def_opaque')
...
!------------------------------- nc_inq_opaque --------------------------------
Interface
 Function nc_inq_opaque(ncid, xtype, name, sizep) BIND(C,name='nc_inq_opaque')
...
!------------------------------- nc_def_var_fill ------------------------------
Interface
 Function nc_def_var_fill(ncid, varid, no_fill, cfill_value_p) BIND(C,name='nc_def_var_fill')
...
!------------------------------- nc_inq_var_fill ------------------------------
Interface
 Function nc_inq_var_fill(ncid, varid, no_fill, fill_value) BIND(C,name='nc_inq_var_fill')
...
!------------------------------- nc_inq_var_szip ------------------------------
Interface
 Function nc_inq_var_szip(ncid, varid, options_mask, pixels_per_block) BIND(C,name='nc_inq_var_szip')
...
Interface
 Function nc_def_var_fletcher32(ncid, varid, fletcher32) BIND(C,name='nc_def_var_fletcher32')
...
Interface
 Function nc_inq_var_fletcher32(ncid, varid, fletcher32) BIND(C,name='nc_inq_var_fletcher32')
...
!------------------------------- nc_def_var_deflate ---------------------------
Interface
 Function nc_def_var_deflate(ncid, varid, shuffle, deflate, deflate_level) BIND(C,name='nc_def_var_deflate')
...
!------------------------------- nc_inq_var_deflate ---------------------------
Interface
 Function nc_inq_var_deflate(ncid, varid, shuffle, deflate, deflate_level) BIND(C,name='nc_inq_var_deflate')
...
!------------------------------- nc_def_var_chunking --------------------------
Interface
 Function nc_def_var_chunking(ncid, varid, contiguousp, chunksizesp) BIND(C,name='nc_def_var_chunking')
...
!------------------------------- nc_inq_var_chunking --------------------------
Interface
 Function nc_inq_var_chunking(ncid, varid, contiguousp, chunksizesp) BIND(C,name='nc_inq_var_chunking')
...
Interface
 Function nc_def_var_chunking_ints(ncid, varid, contiguousp, chunksizesp) BIND(C,name='nc_def_var_chunking_ints')
...
Interface
 Function nc_inq_var_chunking_ints(ncid, varid, contiguousp, chunksizesp) BIND(C,name='nc_inq_var_chunking_ints')
...
!------------------------------- nc_def_var_endian --------------------------
Interface
 Function nc_def_var_endian(ncid, varid, endiann) BIND(C,name='nc_def_var_endian')
...
!------------------------------- nc_inq_var_endian --------------------------
Interface
 Function nc_inq_var_endian(ncid, varid, endiann) BIND(C,name='nc_inq_var_endian')
...
!------------------------------- nc_put_att -----------------------------------
Interface
 Function nc_put_att(ncid, varid, name, xtype, nlen, op) BIND(C,name='nc_put_att')
...
!------------------------------- nc_get_att -----------------------------------
Interface
 Function nc_get_att(ncid, varid, name, op) BIND(C,name='nc_get_att')
...
!------------------------------- nc_put_vlen_element --------------------------
Interface
 Function nc_put_vlen_element(ncid, xtype, vlen_element, nlen, op) BIND(C,name='nc_put_vlen_element')
...
!------------------------------- nc_get_vlen_element --------------------------
Interface
 Function nc_get_vlen_element(ncid, xtype, vlen_element, nlen, op) BIND(C,name='nc_get_vlen_element')
...
!------------------------------- nc_free_vlen ---------------------------------
Interface
 Function nc_free_vlen(vl) BIND(C,name='nc_free_vlen')
...
!------------------------------- nc_free_vlens -------------------------------
Interface
 Function nc_free_vlens(len, vl) BIND(C,name='nc_free_vlens')
...
!------------------------------- nc_free_string ------------------------------
Interface
 Function nc_free_string(len, vl) BIND(C,name='nc_free_string')
...
Interface
 Function nc_put_var1_longlong(ncid, varid, indexp, op) BIND(C,name='nc_put_var1_longlong')
...
Interface
 Function nc_get_var1_longlong(ncid, varid, indexp, ip) BIND(C,name='nc_get_var1_longlong')
...
Interface
 Function nc_put_vara_longlong(ncid, varid, startp, countp, op) BIND(C,name='nc_put_vara_longlong')
...
Interface
 Function nc_get_vara_longlong(ncid, varid, startp, countp, ip) BIND(C,name='nc_get_vara_longlong')
...
Interface
 Function nc_put_varm_longlong(ncid, varid, startp, countp, stridep, imapp, &
                               op) BIND(C,name='nc_put_varm_longlong')
...
Interface
 Function nc_get_varm_longlong(ncid, varid, startp, countp, stridep, imapp, &
                               ip) BIND(C,name='nc_get_varm_longlong')
...
Interface
 Function nc_put_vars_longlong(ncid, varid, startp, countp, stridep, op) BIND(C,name='nc_put_vars_longlong')
...
Interface
 Function nc_get_vars_longlong(ncid, varid, startp, countp, stridep, ip) BIND(C,name='nc_get_vars_longlong')
...
!------------------------------- nc_put_var_longlong --------------------------
Interface
 Function nc_put_var_longlong(ncid, varid, op) BIND(C,name='nc_put_var_longlong')
...
!------------------------------- nc_get_var_longlong --------------------------
Interface
 Function nc_get_var_longlong(ncid, varid, ip) BIND(C,name='nc_get_var_longlong')
...
Interface
 Function nc_set_chunk_cache_ints(size, nelems, preemption) BIND(C,name='nc_set_chunk_cache_ints')
...
Interface
 Function nc_get_chunk_cache_ints(size, nelems, preemption) BIND(C,name='nc_get_chunk_cache_ints')
...
Interface
 Function nc_set_var_chunk_cache_ints(ncid, varid, size, nelems, preemption) BIND(C,name='nc_set_var_chunk_cache_ints')
...
Interface
 Function nc_get_var_chunk_cache_ints(ncid, varid, size, nelems, preemption) BIND(C,name='nc_get_var_chunk_cache_ints')
...
!------------------------------- nc_set_chunk_cache ---------------------------
Interface
 Function nc_set_chunk_cache(size, nelems, preemption) BIND(C,name='nc_set_chunk_cache')
...
!------------------------------- nc_get_chunk_cache ---------------------------
Interface
 Function nc_get_chunk_cache(size, nelems, preemption) BIND(C,name='nc_get_chunk_cache')
