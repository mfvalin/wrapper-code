...
STATIC inline void SplitEvenOdd_8(void * restrict pa, void * restrict pe, void * restrict po){
  int i, j ;
  float * restrict a = (float *) pa ;
  float * restrict e = (float *) pe ;
  float * restrict o = (float *) po ;
...
STATIC inline void SplitEvenOdd_16(void * restrict pa, void * restrict pe, void * restrict po){
  int i, j ;
  float * restrict a = (float *) pa ;
  float * restrict e = (float *) pe ;
  float * restrict o = (float *) po ;
...
STATIC inline void SplitEvenOdd_32(void * restrict pa, void * restrict pe, void * restrict po){
  int i, j ;
  float * restrict a = (float *) pa ;
  float * restrict e = (float *) pe ;
  float * restrict o = (float *) po ;
...
STATIC inline void SplitEvenOdd_64(void * restrict pa, void * restrict pe, void * restrict po){
  int i, j ;
  float * restrict a = (float *) pa ;
  float * restrict e = (float *) pe ;
  float * restrict o = (float *) po ;
...
STATIC inline void SplitEvenOdd_n(void * restrict pa, void * restrict pe, void * restrict po, int n){
  int i, j ;
  int nodd = n >> 1 ;
  float * restrict a = (float *) pa ;
  float * restrict e = (float *) pe ;
...
//   if(n < 8 && n > 0){
  for(i=0, j=0 ; j<(nodd & 0x3) ; j++, i+=2){
    e[j] = a[i] ;
    o[j] = a[i+1] ;
  }
  if(n&1) e[j] = a[i] ;  // n was odd ?
//   }
  return ;
}
